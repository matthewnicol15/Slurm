...
echo 'gROOT->ProcessLine("FTOF_Unified_2D(\"/cache/clas12/rg-a/production/recon/fall2018/torus+1/pass1/v0/dst/recon/00'$NUMBER'/*.hipo\",\"/volatile/clas12/matthewn/FTOF/RGA_Fall18_Outbending/RGA_Fall18_Outbending_'$NUMBER'.root\")");' >> process_FTOF"$NUMBER".sh
